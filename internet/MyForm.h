...
#pragma region Windows Form Designer generated code
		...
		void InitializeComponent(void)
		{
			...
			this->button2->Size = System::Drawing::Size(246, 71);
			...
			this->label1->Size = System::Drawing::Size(491, 37);
			this->label1->TabIndex = 2;
			this->label1->Text = L"интернет магазин у тёти Люды ";
			// 
			// panel1
			// 
			...
			this->panel1->Size = System::Drawing::Size(227, 100);
			...
			this->ClientSize = System::Drawing::Size(491, 499);
